...
- [x] RELEASE-051-1 Updated patch metadata and notes to 0.5.1/build 6; release build, strict signature, bundled runtime hashes and public SwiftMusic 0.5.1 verified. No local dependency references in tracked manifests `depends:ISSUES-INT` `parallel:none`
- [ ] RELEASE-051-INT Verify unchanged production evidence and release candidate; publish matching main tag and GitHub source preview `depends:RELEASE-051-1` `parallel:none`
