...
## Publishing
Serve this directory with any static server. GitHub Pages can use main /docs with its native branch publishing. This task prepares the page; enabling public hosting is a separate operation. No package installation or build step is required.
...
- `musicplayground-app.png`: native CUA screenshot of LiveSet051 running both template decks, captured September 12, 2026. No synthesized UI or substituted code.
