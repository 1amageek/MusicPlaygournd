...
- [x] UPDATE-051-2 Host, evaluator/completion manifests, new-project template, tracked example and docs pin public 0.5.1 (bffb25e); 12 Release tests passed including generated project/native PCM, both slider paths, real SourceKit completions, multi-file dependencies and synthesis PCM regression. Public checkout state verified; commit: Update SwiftMusic dependency and templates to 0.5.1 `depends:UPDATE-051-1` `parallel:none`
- [ ] UPDATE-051-INT Build packaged app and verify generated-template evaluation/native playback with released dependency; commit/push host updates `depends:UPDATE-051-1,UPDATE-051-2` `parallel:none`
